...
public enum BoomerangError {
  ...
  WORKFLOW_NOT_ACTIVE(1102, "WORKFLOW_NOT_ACTIVE", HttpStatus.BAD_REQUEST),
  WORKFLOW_DELETED(1103, "WORKFLOW_DELETED", HttpStatus.BAD_REQUEST),
  ...
  TASK_TEMPLATE_INACTIVE_STATUS(1505, "TASK_TEMPLATE_INACTIVE_STATUS", HttpStatus.BAD_REQUEST),
