...
public enum BoomerangError {
  ...
  TASKRUN_INVALID_PARAMS(1502, "TASKRUN_INVALID_PARAMS", HttpStatus.BAD_REQUEST),
  TASKRUN_INVALID_END_STATUS(1504, "TASKRUN_INVALID_END_STATUS", HttpStatus.BAD_REQUEST),
